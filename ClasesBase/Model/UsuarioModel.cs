...
namespace ClasesBase
{
    ...
    {   //Ejecutamos una consulta a la base de dato.
        ...
        public static DataTable listarRol() {
            ...
            //SqlConnection cnn = new SqlConnection("Data Source=.\\SQLEXPRESS;AttachDbFilename=C:\\Users\\car\\Downloads\\Tp2-LPOO1\\LPOO1_GRUPO04\\ClasesBase\\pasteleriaDB.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True");
        ...
        public static void insert_auditoria(Historial_Login hl)
        {
            ...
            cmd.CommandText = "INSERT INTO Historial_Login(hlog_fecha_hora,usr_id) values(@hlog,@id)";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = cnn;
