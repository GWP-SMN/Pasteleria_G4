...
namespace Vistas
{
    public partial class FrmABMUsuario : Form
    {
        ...
        private void btnGuardarUsuario_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Ingrese valores uno o mas campos vacios !!!");
            }*/
        }
       ...
       /*
        //Lo carga en una grilla a los usaurios agregados: Model de la clase UsuarioModel
      ...
      */
        ...
        {
            //lo deshabilitamos para que no se modifique
           //* txtUserName.Enabled = false;
            //lo deshabilitamos el boton Guardar para que no pueda repetir el mismo usuario.
        ...
        public void BorrarCampos(GroupBox gb)
        {
            foreach (var combo in gb.Controls)
            {
                ...
                //btnGuardarUsuario.Enabled = true;//podria estar afuera
            }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Ingrese alguna letra: Apellido ó Nonbre");
            }
        }
